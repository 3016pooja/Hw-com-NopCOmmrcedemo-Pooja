...
public class ComputerPageTest extends BaseTest {
    ...
    public void verifyProductArrangeInAlphaBaticalOrder(){
        ...
        //System.out.println("The number of products on page are:" +( computerPage.verifyProductsArrangeDescendingOrder().size())
    }
    @Test
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
      ...
      computerPage.clickonMicrosoftOfficeOption();
       ...
       // Assert.assertEquals(computerPage.verifyWelcomSignInText(),"Welcome, Please Sign In!","text verified");
        ...
        computerPage.sendTextToFirstName();
        computerPage.sendTextToLastName();
        computerPage.sendTextToEmailIdField();
        computerPage.sendTextToCountryField();
        computerPage.sendTextToCityField();
        computerPage.sendTextToAdressField();
        computerPage.sendTextToZipCodeField();
        computerPage.sendTextToPhoneNumberField();
