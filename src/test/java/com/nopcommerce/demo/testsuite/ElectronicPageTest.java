...
public class ElectronicPageTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        electronicsPage.sentTextToFirstName();
        electronicsPage.sentTextToLastName();
        electronicsPage.sentTextToEmailId();
        electronicsPage.sentTextToPassword();
        electronicsPage.sentTextToconfirmPassword();
