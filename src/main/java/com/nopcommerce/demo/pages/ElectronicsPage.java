...
public class ElectronicsPage extends Utility {
    ...
    By cellphonesText = By.xpath("//body/div[6]/div[2]/ul[1]/li[2]/ul[1]/li[2]/a[1]");
    By listViewclick = By.xpath("//a[contains(text(),'List')]");
    By nokiaProduct = By.xpath("//body/div[6]/div[3]/div[1]/div[3]/div[1]/div[2]/div[2]/div[2]/div[1]/div[1]/div[3]/div[1]/div[2]/h2[1]/a[1]");

    By nonokiaProduct = By.xpath("//body/div[6]/div[3]/div[1]/div[3]/div[1]/div[2]/div[2]/div[2]/div[1]/div[1]/div[3]/div[1]/div[2]/h2[1]/a[1]");
...
By logoutLink2=By.xpath("//a[@class='ico-logout']");
    ...
    public void sentTextToFirstName() {
        sendTextToElement(firstName, "saloni");
    }

    public void sentTextToLastName() {
        sendTextToElement(lastNmae, "dshavra");
    }

    public void sentTextToEmailId() {
        sendTextToElement(emailId, "tanviparekh23@gmail.com");
    }

    public void sentTextToPassword() {
        sendTextToElement(password, "myherois125");
    }
    public void sentTextToconfirmPassword() {
        sendTextToElement(confirmPassword, "myherois125");
    }
    ...
    public void enterResidanceAddress() {
        sendTextToElement(address, "25 Pratiksa");
    }

    public void enterZipcodeofArea() {
        sendTextToElement(postOcde, "ha35hy");
    }

    public void enterPhoneNumber() {
        sendTextToElement(phoneNumber, "07500087124");
    }
