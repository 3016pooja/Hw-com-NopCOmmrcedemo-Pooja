...
// 2.14	Then MouseHover on "Shopping cart" and Click on "GO TO CART" button.
   ...
   // 2.18	click on checkbox “I agree with the terms of service”
    ...
    public void sendTextToFirstName(){
        sendTextToElement(firstNameField,"Maya");
    }
    public void sendTextToLastName(){
        sendTextToElement(lastNameField,"adutta");
    }
    public void sendTextToEmailIdField(){
        sendTextToElement(emailIdFiedl,"rahulmahaj12123@gmail.com");
    }
    public void sendTextToCountryField(){
        sendTextToElement(counrtyNameField,"India");
    }
    public void sendTextToCityField(){
        sendTextToElement(cityNameFiled,"Delhi");
    }
    public void sendTextToAdressField(){
        sendTextToElement(addressField,"28,karolbaugh");
    }
    public void sendTextToZipCodeField(){
        sendTextToElement(postcodeField,"HA28PS");
    }
    public void sendTextToPhoneNumberField(){
        sendTextToElement(phoneNumber,"07500025461");
    }
